...
#process.PatJetTriggerMatchHLTIsoMuBTagIP.matchedCuts = cms.string( 'path( "HLT_IsoMu17_eta2p1_CentralJet30_BTagIP_v*" )' )
switchOnTriggerMatchEmbedding(process,triggerMatchers = ['PatJetTriggerMatchHLTIsoMuBTagIP'])
...
#process.patPF2PATSequence.remove(process.patMETs)
...
#process.patType1CorrectedPFMet.srcType1Corrections = cms.VInputTag(cms.InputTag("patPFJetMETtype1p2Corr","type1"), cms.InputTag("patPFMETtype0Corr") )
#process.patType1p2CorrectedPFMet.srcType1Corrections = cms.VInputTag(cms.InputTag("patPFJetMETtype1p2Corr","type1"), cms.InputTag("patPFMETtype0Corr") )
#process.pfCandMETcorr.src = cms.InputTag('pfNoJet')
...
#process.patPFJetMETtype2Corr.skipEM = cms.bool(False)
#process.patPFJetMETtype2Corr.skipMuons = cms.bool(False)

#process.patMETs.metSource = cms.InputTag('patType1p2CorrectedPFMet')
#process.patPF2PATSequence.remove(process.patMETs)
...
#process.patseq.remove(process.patseq.FastjetJetProducer)

process.pathPreselection = cms.Path(
        process.patseq #+  process.producePatPFMETCorrections + process.patMETs
        )
...
'/store/data/Run2011B/SingleMu/AOD/19Nov2011-v1/0009/6C809405-081B-E111-9BB5-001CC4C11074.root',
#'/store/data/Run2011A/SingleMu/AOD/08Nov2011-v1/0003/7C456B6B-D40F-E111-B781-00237DA13FC2.root'
#'/store/data/Run2011A/SingleMu/AOD/08Nov2011-v1/0003/D8E86C89-8413-E111-BACB-0017A4770C28.root'
),
#eventsToProcess = cms.untracked.VEventRange('1:2807840-1:2807840'),
duplicateCheckMode = cms.untracked.string('noDuplicateCheck')
)

ChannelName = "Mu_2011B_19Nov";
