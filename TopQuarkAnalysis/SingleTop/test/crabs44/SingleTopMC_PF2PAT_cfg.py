...
#'file:/tmp/mmerola/F81B1889-AF4B-DF11-85D3-001A64789DF4.root'
#'file:/tmp/mmerola/EC0EE286-FA55-E011-B99B-003048F024F6.root'
#'file:/tmp/mmerola/D0B32FD9-6D87-E011-8572-003048678098.root'
#'file:/tmp/mmerola/149E3017-B799-E011-9FA9-003048F118C2.root'
#'file:/tmp/mmerola/FE4EF257-A3AB-E011-9698-00304867915A.root',
#'file:/tmp/mmerola/50A31B1A-8AAB-E011-835B-0026189438F5.root'
#'file:/tmp/mmerola/WJetsSmallFile_1_1_nb1.root',
#'file:/tmp/mmerola/00012F91-72E5-DF11-A763-00261834B5F1.root',
),
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/"+ChannelName+"_pt_bmode.root"))
...
#                                fileName = cms.untracked.string('rfio:/CST/cern.ch/user/o/mmerola/SingleTop/SubSkims/WControlSamples1.root'),
#                   fileName = cms.untracked.Bstring('/tmp/mmerola/edmntuple_tchannel_big.root'),
#                   fileName = cms.untracked.string('/tmp/mmerola/edmntuple_'+ChannelName+'.root'),
