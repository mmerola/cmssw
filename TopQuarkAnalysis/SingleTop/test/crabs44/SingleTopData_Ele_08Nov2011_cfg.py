...
#process.pfIsolatedElectrons.isolationValueMapsCharged = cms.VInputTag( cms.InputTag("elPFIsoValueCharged04"),    )
#process.pfIsolatedElectrons.isolationValueMapsNeutral = cms.VInputTag( cms.InputTag("elPFIsoValueNeutral04"),  cms.InputTag("elPFIsoValueGamma04")  )
#process.pfIsolatedElectrons.deltaBetaIsolationValueMap = cms.InputTag("elPFIsoValuePU04")


# NOT for gsfElectrons
#process.patElectrons.isolationValues = cms.PSet(
#    pfChargedHadrons = cms.InputTag("elPFIsoValueCharged04"),
#    pfChargedAll = cms.InputTag("elPFIsoValueChargedAll04"),
#    pfPUChargedHadrons = cms.InputTag("elPFIsoValuePU04"),
...
#'file:/tmp/oiorio/',
"/store/data/Run2011A/SingleElectron/AOD/08Nov2011-v1/0000/6A874970-5A0D-E111-B97A-0030487F1309.root"
