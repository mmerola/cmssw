...
switchOnTriggerMatchEmbedding(process,triggerMatchers = ['PatJetTriggerMatchHLTIsoEleBTagIP'])
...
#'/store/data/Run2011A/ElectronHad/AOD/08Nov2011-v1/0001/FE6CEC08-DE1A-E111-ADFA-001EC9D8A8BC.root'
),
#eventsToProcess = cms.untracked.VEventRange('1:2807840-1:2807840'),
duplicateCheckMode = cms.untracked.string('noDuplicateCheck')
)

ChannelName = "Ele_2011A_08Nov";
...
savePatTupleSkimLoose = cms.untracked.vstring(
    ...
    "keep *_PatJetTriggerMatchHLTIsoEleBTagIP_*_*",#Trigger matches
    "keep *_patTrigger_*_*",
