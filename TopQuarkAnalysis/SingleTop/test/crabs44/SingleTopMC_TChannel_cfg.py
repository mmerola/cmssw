...
#usePF2PAT(process,runPF2PAT=True, jetAlgo='AK5', runOnMC=True, postfix=postfix, typeIMetCAorrections=True)
...
process.patElectrons.isolationValues = cms.PSet( pfChargedHadrons = cms.InputTag("elPFIsoValueCharged03"), pfChargedAll = cms.InputTag("elPFIsoValueChargedAll03"), pfPUChargedHadrons = cms.InputTag("elPFIsoValuePU03"), pfNeutralHadrons = cms.InputTag("elPFIsoValueNeutral03"), pfPhotons = cms.InputTag("elPFIsoValueGamma03") )
...
process.patMuons.isolationValues = cms.PSet( pfChargedHadrons = cms.InputTag("muPFIsoValueCharged03"), pfChargedAll = cms.InputTag("muPFIsoValueChargedAll03"), pfPUChargedHadrons = cms.InputTag("muPFIsoValuePU03"), pfNeutralHadrons = cms.InputTag("muPFIsoValueNeutral03"), pfPhotons = cms.InputTag("muPFIsoValueGamma03") )
...
#'file:/tmp/oiorio/CA565522-FA6B-E111-9089-002590200B3C.root',
...
if doMCTruth:
    ...
    saveNTuplesSkimLoose.append('keep *_MCTruthParticles_*_*')
