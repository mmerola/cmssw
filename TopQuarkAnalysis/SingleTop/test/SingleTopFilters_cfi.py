...
HLTFilterMuData = cms.EDFilter('SingleTopTriggers',
                           HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                           isMC = cms.untracked.bool(False),
                           triggerList = cms.vstring("HLT_IsoMu17_v","HLT_IsoMu17_CentralJet30_BTagIP_v","HLT_IsoMu17_eta2p1_CentralJet30_BTagIP_v",
                                                     ),
                           runRangesList = cms.vint32(160431, 167913, 173198),
                           
                           channel = cms.untracked.int32(2),#Useless now
                           )

HLTFilterMuDataLepton = cms.EDFilter('SingleTopTriggers',
                           HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                           isMC = cms.untracked.bool(False),
                           triggerList = cms.vstring("HLT_IsoMu24_v","HLT_IsoMu24_eta2p1_v",
                                                     ),
                           runRangesList = cms.vint32(160431, 173198),
                           
                           channel = cms.untracked.int32(2),#Useless now
                           )                         

HLTFilterMuMC = cms.EDFilter('SingleTopTriggers',
                           HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                           isMC = cms.untracked.bool(False),
                           triggerList = cms.vstring("HLT_IsoMu17_v",
                                                     ),
...
HLTFilterMuMCxTrigger = cms.EDFilter('SingleTopTriggers',
                           HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                           isMC = cms.untracked.bool(False),
                           triggerList = cms.vstring("HLT_IsoMu17_v","HLT_IsoMu17_CentralJet30_BTagIP_v","HLT_IsoMu17_eta2p1_CentralJet30_BTagIP_v",
                                                     ),
