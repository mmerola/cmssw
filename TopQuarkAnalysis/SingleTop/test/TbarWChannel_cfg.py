...
'file:/tmp/mmerola/TbarWChannelMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TbarWChannelMerged.root',
...
#from TbarWChannel import *
#process.source.fileNames = TbarWChannel_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TbarWChannelMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TbarWChannel.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TbarWChannel.root"))
...
process.TreesEle.channelInfo = TbarWChannelEle
process.TreesMu.channelInfo = TbarWChannelMu
#process.PlotsEle.channelInfo = TbarWChannelEle
#process.PlotsMu.channelInfo = TbarWChannelMu
