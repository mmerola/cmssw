...
'file:/tmp/mmerola/TbarChannelMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TbarChannelMerged.root',
...
#from TbarChannel import *
#process.source.fileNames = TbarChannel_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TbarChannelMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TbarChannel_part_1.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TbarChannel_part_1.root"))
...
process.TreesEle.channelInfo = TbarChannelEle
process.TreesMu.channelInfo = TbarChannelMu
#process.PlotsEle.channelInfo = TbarChannelEle
#process.PlotsMu.channelInfo = TbarChannelMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/TbarChannel_part_1Merged.root',)