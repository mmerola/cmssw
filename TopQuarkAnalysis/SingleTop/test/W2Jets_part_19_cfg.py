...
'file:/tmp/mmerola/W2JetsMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/W2JetsMerged.root',
...
#from W2Jets import *
#process.source.fileNames = W2Jets_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/W2JetsMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W2Jets_part_19.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W2Jets_part_19.root"))
...
process.TreesEle.channelInfo = W2JetsEle
process.TreesMu.channelInfo = W2JetsMu
#process.PlotsEle.channelInfo = W2JetsEle
#process.PlotsMu.channelInfo = W2JetsMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W2Jets_part_19Merged.root',)