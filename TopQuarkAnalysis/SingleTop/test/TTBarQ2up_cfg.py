...
'file:/tmp/mmerola/TTBarQ2upMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TTBarQ2upMerged.root',
...
#from TTBarQ2up import *
#process.source.fileNames = TTBarQ2up_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TTBarQ2upMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TTBarQ2up.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TTBarQ2up.root"))
...
process.TreesEle.channelInfo = TTBarQ2upEle
process.TreesMu.channelInfo = TTBarQ2upMu
#process.PlotsEle.channelInfo = TTBarQ2upEle
#process.PlotsMu.channelInfo = TTBarQ2upMu
