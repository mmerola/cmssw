...
'file:/tmp/mmerola/WWMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/WWMerged.root',
...
#from WW import *
#process.source.fileNames = WW_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/WWMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/WW.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/WW.root"))
...
process.TreesEle.channelInfo = WWEle
process.TreesMu.channelInfo = WWMu
#process.PlotsEle.channelInfo = WWEle
#process.PlotsMu.channelInfo = WWMu
