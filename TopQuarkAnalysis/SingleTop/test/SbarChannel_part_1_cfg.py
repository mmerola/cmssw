...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/tmp/mmerola/edmntuple_SbarChannel_1_1_QBt.root', 
        'file:/tmp/mmerola/edmntuple_SbarChannel_2_1_ApL.root', 
        'file:/tmp/mmerola/edmntuple_SbarChannel_3_1_DNc.root')
)
...
process.skimwall = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/tmp/mmerola/SbarChannelMerged.root'),
