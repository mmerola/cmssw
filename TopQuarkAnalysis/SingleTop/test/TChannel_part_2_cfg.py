...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TChannel_part_2.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TChannel_part_2.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/TChannel_part_2Merged.root',)