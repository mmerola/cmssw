...
'file:/tmp/mmerola/SChannelMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/SChannelMerged.root',
...
#from SChannel import *
#process.source.fileNames = SChannel_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/SChannelMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/SChannel.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/SChannel.root"))
...
process.TreesEle.channelInfo = SChannelEle
process.TreesMu.channelInfo = SChannelMu
#process.PlotsEle.channelInfo = SChannelEle
#process.PlotsMu.channelInfo = SChannelMu
