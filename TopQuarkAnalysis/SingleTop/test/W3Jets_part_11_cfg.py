...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W3Jets_part_11.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W3Jets_part_11.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W3Jets_part_11Merged.root',)