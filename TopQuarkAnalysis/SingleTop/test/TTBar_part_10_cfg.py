...
'file:/tmp/mmerola/TTBarMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TTBarMerged.root',
...
#from TTBar import *
#process.source.fileNames = TTBar_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TTBarMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TTBar_part_10.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TTBar_part_10.root"))
...
process.TreesEle.channelInfo = TTBarEle
process.TreesMu.channelInfo = TTBarMu
#process.PlotsEle.channelInfo = TTBarEle
#process.PlotsMu.channelInfo = TTBarMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/TTBar_part_10Merged.root',)