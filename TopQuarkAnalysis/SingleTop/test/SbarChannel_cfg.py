...
'file:/tmp/mmerola/SbarChannelMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/SbarChannelMerged.root',
...
#from SbarChannel import *
#process.source.fileNames = SbarChannel_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/SbarChannelMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/SbarChannel.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/SbarChannel.root"))
...
process.TreesEle.channelInfo = SbarChannelEle
process.TreesMu.channelInfo = SbarChannelMu
#process.PlotsEle.channelInfo = SbarChannelEle
#process.PlotsMu.channelInfo = SbarChannelMu
