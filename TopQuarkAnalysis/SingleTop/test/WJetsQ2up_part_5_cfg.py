...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/WJetsQ2up_part_5.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/WJetsQ2up_part_5.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/WJetsQ2up_part_5Merged.root',)