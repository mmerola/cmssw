...
'file:/tmp/mmerola/WJetsQ2downMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/WJetsQ2downMerged.root',
...
#from WJetsQ2down import *
#process.source.fileNames = WJetsQ2down_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/WJetsQ2downMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/WJetsQ2down_part_2.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/WJetsQ2down_part_2.root"))
...
process.TreesEle.channelInfo = WJetsQ2downEle
process.TreesMu.channelInfo = WJetsQ2downMu
#process.PlotsEle.channelInfo = WJetsQ2downEle
#process.PlotsMu.channelInfo = WJetsQ2downMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/WJetsQ2down_part_2Merged.root',)