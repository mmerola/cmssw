...
'file:/tmp/mmerola/TTBarQ2downMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TTBarQ2downMerged.root',
...
#from TTBarQ2down import *
#process.source.fileNames = TTBarQ2down_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TTBarQ2downMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TTBarQ2down.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TTBarQ2down.root"))
...
process.TreesEle.channelInfo = TTBarQ2downEle
process.TreesMu.channelInfo = TTBarQ2downMu
#process.PlotsEle.channelInfo = TTBarQ2downEle
#process.PlotsMu.channelInfo = TTBarQ2downMu
