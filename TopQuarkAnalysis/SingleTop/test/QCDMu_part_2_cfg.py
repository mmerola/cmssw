...
'file:/tmp/mmerola/QCDMuMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/QCDMuMerged.root',
...
#from QCDMu import *
#process.source.fileNames = QCDMu_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/QCDMuMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/QCDMu_part_2.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/QCDMu_part_2.root"))
...
process.TreesEle.channelInfo = QCDMuEle
process.TreesMu.channelInfo = QCDMuMu
#process.PlotsEle.channelInfo = QCDMuEle
#process.PlotsMu.channelInfo = QCDMuMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/QCDMu_part_2Merged.root')
