...
'file:/tmp/mmerola/WJetsQ2upMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/WJetsQ2upMerged.root',
...
#from WJetsQ2up import *
#process.source.fileNames = WJetsQ2up_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/WJetsQ2upMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/WJetsQ2up_part_3.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/WJetsQ2up_part_3.root"))
...
process.TreesEle.channelInfo = WJetsQ2upEle
process.TreesMu.channelInfo = WJetsQ2upMu
#process.PlotsEle.channelInfo = WJetsQ2upEle
#process.PlotsMu.channelInfo = WJetsQ2upMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/WJetsQ2up_part_3Merged.root',)