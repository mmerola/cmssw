...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/ZJets_part_8.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/ZJets_part_8.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/ZJets_part_8Merged.root',)