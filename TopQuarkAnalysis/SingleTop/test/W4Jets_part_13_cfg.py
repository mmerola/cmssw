...
'file:/tmp/mmerola/W4JetsMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/W4JetsMerged.root',
...
#from W4Jets import *
#process.source.fileNames = W4Jets_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/W4JetsMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W4Jets_part_13.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W4Jets_part_13.root"))
...
process.TreesEle.channelInfo = W4JetsEle
process.TreesMu.channelInfo = W4JetsMu
#process.PlotsEle.channelInfo = W4JetsEle
#process.PlotsMu.channelInfo = W4JetsMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W4Jets_part_13Merged.root',)