...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W2Jets_part_6.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W2Jets_part_6.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W2Jets_part_6Merged.root',)