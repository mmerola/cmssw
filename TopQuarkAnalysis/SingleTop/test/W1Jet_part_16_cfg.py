...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W1Jet_part_16.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W1Jet_part_16.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W1Jet_part_16Merged.root',)