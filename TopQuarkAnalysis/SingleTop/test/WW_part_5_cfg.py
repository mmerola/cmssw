...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/tmp/mmerola/edmntuple_WW_1_1_PbL.root', 
        'file:/tmp/mmerola/edmntuple_WW_2_1_VUD.root', 
        'file:/tmp/mmerola/edmntuple_WW_3_1_ziW.root')
)
...
process.skimwall = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/tmp/mmerola/WW_part_5Merged.root'),
