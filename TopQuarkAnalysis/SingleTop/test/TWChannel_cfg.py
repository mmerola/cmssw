...
'file:/tmp/mmerola/TWChannelMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TWChannelMerged.root',
...
#process.source.fileNames = TWChannel_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TWChannelMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TWChannel.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TWChannel.root"))
...
process.TreesEle.channelInfo = TWChannelEle
process.TreesMu.channelInfo = TWChannelMu
#process.PlotsEle.channelInfo = TWChannelEle
#process.PlotsMu.channelInfo = TWChannelMu
