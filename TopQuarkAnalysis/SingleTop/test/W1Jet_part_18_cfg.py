...
'file:/tmp/mmerola/W1JetMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/W1JetMerged.root',
...
#from W1Jet import *
#process.source.fileNames = W1Jet_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/W1JetMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W1Jet_part_18.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W1Jet_part_18.root"))
...
process.TreesEle.channelInfo = W1JetEle
process.TreesMu.channelInfo = W1JetMu
#process.PlotsEle.channelInfo = W1JetEle
#process.PlotsMu.channelInfo = W1JetMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W1Jet_part_18Merged.root',)