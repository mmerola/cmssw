...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/tmp/mmerola/edmntuple_SChannel_1_1_kQ1.root', 
        'file:/tmp/mmerola/edmntuple_SChannel_2_1_exS.root', 
        'file:/tmp/mmerola/edmntuple_SChannel_3_1_I2D.root', 
        'file:/tmp/mmerola/edmntuple_SChannel_4_1_6Gl.root')
)
...
process.skimwall = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/tmp/mmerola/SChannelMerged.root'),
