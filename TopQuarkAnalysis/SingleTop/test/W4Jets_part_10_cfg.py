...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/W4Jets_part_10.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/W4Jets_part_10.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/W4Jets_part_10Merged.root',)