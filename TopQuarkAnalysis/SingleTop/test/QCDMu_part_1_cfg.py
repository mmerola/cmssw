...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/QCDMu_part_1.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/QCDMu_part_1.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/QCDMu_part_1Merged.root')
