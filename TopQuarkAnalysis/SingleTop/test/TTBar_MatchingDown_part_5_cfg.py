...
'file:/tmp/mmerola/TTBar_MatchingDownMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/TTBar_MatchingDownMerged.root',
...
#from TTBar_MatchingDown import *
#process.source.fileNames = TTBar_MatchingDown_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/TTBar_MatchingDownMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/TTBar_MatchingDown_part_5.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/TTBar_MatchingDown_part_5.root"))
...
process.TreesEle.channelInfo = TTBar_MatchingDownEle
process.TreesMu.channelInfo = TTBar_MatchingDownMu
#process.PlotsEle.channelInfo = TTBar_MatchingDownEle
#process.PlotsMu.channelInfo = TTBar_MatchingDownMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/TTBar_MatchingDown_part_5Merged.root',)