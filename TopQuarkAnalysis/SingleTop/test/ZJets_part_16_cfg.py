...
#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/ZJets_part_16.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/ZJets_part_16.root"))
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/ZJets_part_16Merged.root',)