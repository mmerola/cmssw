...
'file:/tmp/mmerola/ZJetsMerged.root',
#'rfio:/castor/cern.ch/user/m/mmerola/SingleTop_2012/MergedJune/ZJetsMerged.root',
...
#from ZJets import *
#process.source.fileNames = ZJets_ntuple
#process.source.fileNames = cms.untracked.vstring("file:/tmp/mmerola/ZJetsMerged.root")

#PileUpSync

#Output
#process.TFileService = cms.Service("TFileService", fileName = cms.string("/castor/cern.ch/user/m/mmerola/SingleTop_2012/TreesJune/ZJets_part_11.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("/tmp/mmerola/ZJets_part_11.root"))
...
process.TreesEle.channelInfo = ZJetsEle
process.TreesMu.channelInfo = ZJetsMu
#process.PlotsEle.channelInfo = ZJetsEle
#process.PlotsMu.channelInfo = ZJetsMu
...
process.source.fileNames = cms.untracked.vstring('file:/tmp/mmerola/ZJets_part_11Merged.root',)