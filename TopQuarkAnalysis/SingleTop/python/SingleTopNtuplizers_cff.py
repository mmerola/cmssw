...
nTupleAllJets = nTupleTopJetsPF.clone(
    ...
    quantity = cms.untracked.string("1-triggerObjectMatchesByPath(\"HLT_IsoMu17_CentralJet30_BTagIP_v*\",1).empty()"),
    ),
    cms.PSet(
    tag = cms.untracked.string("isMatchedByHLTIsoMu17eta2p1CentralJet30BTagIP"),
    quantity = cms.untracked.string("1-triggerObjectMatchesByPath(\"HLT_IsoMu17_eta2p1_CentralJet30_BTagIP_v*\",1).empty()"),
    ),
    cms.PSet(
    tag = cms.untracked.string("isMatchedByHLTIsoEle25CentralJet30BTagIP"),
    quantity = cms.untracked.string("1-triggerObjectMatchesByPath(\"HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_CentralJet30_BTagIP_v*\",1).empty()"),
    ),
#    cms.PSet(
#    tag = cms.untracked.string("isMatchedByHLTIsoMu17eta2p1CentralJet30"),
#    quantity = cms.untracked.string("1-triggerObjectMatchesByPath(\"HLT_IsoMu17_eta2p1_CentralJet30_v*\").empty()"),
#    ),
    #4-momentum
    cms.PSet(
    tag = cms.untracked.string("Pt"),
