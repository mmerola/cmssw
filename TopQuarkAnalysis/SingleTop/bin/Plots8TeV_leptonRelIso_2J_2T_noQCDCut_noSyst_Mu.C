...
TString observable = "leptonRelIso";   double observableMin = 0.0;   double observableMax = 0.4;  TString observableName = "Iso_{rel}"; double nBins = 30; TString oTitle = observable;
