...
TString observable = "leptonPt";   double observableMin = 20;   double observableMax = 160;  TString observableName = "p_{T,\#mu}(GeV)"; double nBins = 12;TString oTitle = observable;
