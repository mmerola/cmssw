...
TString observable = "metPt";   double observableMin = 0;   double observableMax = 200;  TString observableName = "E_{T,miss}(GeV)"; double nBins = 14;TString oTitle = observable;
