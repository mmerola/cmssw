...
TString observable = "nJ";   double observableMin = 0;   double observableMax = 8;  TString observableName = "nJetsLoose"; double nBins = 8; TString oTitle = "nJetsLoose";
